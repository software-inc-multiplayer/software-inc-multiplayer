    ...
    namespace Utils
    {
        ...
        namespace Controls
        {
            namespace Window
            {
                ...
                {
                    public Text obj { get; private set; }
                ...
                {
                    public Button obj { get; private set; }
                ...
                {
                    public Slider obj { get; private set; }
                ...
                {
                    public GUICombobox obj { get; private set; }
                ...
                {
                    public Toggle obj { get; private set; }
                ...
                {
                    public InputField obj { get; private set; }
                ...
                {
                    public GUIToolTipper obj { get; private set; }
            ...
            namespace Element
            {
                ...
                public class UIBorder : MaskableGraphic
                {
                    ...
                    [SerializeField]
                    [Range(1, 10)]
                    private int cornerSegment = 2;

                    [SerializeField]
                    private float width = 10;

                    //[SerializeField]
                    private Texture texture = Texture2D.blackTexture;
                    ...
                    private static List<UIVertex> vertexStream = new List<UIVertex>();
                    private static List<int> indexStream = new List<int>();
                    ...
                    private void GenerateBox(Rect r, VertexHelper vh)
                    {
                    ...
                    private void GenerateCorner(Rect rect, VertexHelper vh)
                    {
                        vertexStream.Clear();
                        indexStream.Clear();
                        vh.Clear();
                    ...
                    private void PopulateUV(List<UIVertex> vertexStream)
                    {
                        float length = 0;
                    ...
                    private void AddLine(List<UIVertex> vertexStream, List<int> indexStream, Vector3 begin, Vector3 end)
                    {
                    ...
                    private void BeginLine(List<UIVertex> vertexStream, List<int> indexStream, Vector3 begin, Vector3 end)
                    {
                        UIVertex outer = UIVertex.simpleVert;
                        UIVertex inner = UIVertex.simpleVert;
                    ...
                    private void AddTopLeftCorner(List<UIVertex> vertexStream, List<int> indexStream, Vector3 begin, Vector3 end)
                    {
                    ...
                    private void AddTopRightCorner(List<UIVertex> vertexStream, List<int> indexStream, Vector3 begin, Vector3 end)
                    {
                        /// 使用 innerEdge  半径小于 宽度时，否则 计算 inner Point
                        float offset = width - cornerRadius;
                        if (offset > 0)
                    ...
                    private void AddBottomRightCorner(List<UIVertex> vertexStream, List<int> indexStream, Vector3 begin, Vector3 end)
                    {
                        /// 使用 innerEdge  半径小于 宽度时，否则 计算 inner Point
                        float offset = width - cornerRadius;
                        if (offset > 0)
                    ...
                    private void AddBottomLeftCorner(List<UIVertex> vertexStream, List<int> indexStream, Vector3 begin, Vector3 end)
                    {
                        /// 使用 innerEdge  半径小于 宽度时，否则 计算 inner Point
                        float offset = width - cornerRadius;
                        if (offset > 0)
                    ...
                    private void AddArc(List<UIVertex> vertexStream, List<int> indexStream, Vector3 arcBegin, Vector3 arcEnd, Vector3? innerEdge = null)
                    {
                    ...
                    private void AddSegment(List<UIVertex> vertexStream, List<int> indexStream, Vector3 outter, Vector3 inner)
                    {
                    ...
                    private void AddSegment(List<UIVertex> vertexStream, List<int> indexStream, UIVertex outter, UIVertex inner)
                    {
